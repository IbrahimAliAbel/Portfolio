...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const phoneNumber = '6282141334921';
  ...
  return (
    <div id="contact" className="min-h-screen bg-gradient-to-br from-black via-gray-900/30 to-black px-8 md:px-16 py-16 lg:py-24 pt-24 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start mb-16">
          ...
          >
            ...
            >
              ...
              >
                {[
                  { icon: Mail, label: "Email", value: "ibrahimaliabel019@gmail.com", gradient: "from-white to-gray-300" },
                  { icon: Phone, label: "Phone", value: "+62 82141334921", gradient: "from-gray-200 to-white" },
            ...
            >
              ...
              >
                {[
                  { icon: Github, name: "GitHub", handle: "@IbrahimAliAbel", url: "https://github.com/IbrahimAliAbel", color: "text-white" },
                  { icon: Linkedin, name: "LinkedIn", handle: "Ibrahim Ali Abel", url: "https://www.linkedin.com/in/ibrahim-ali-abel-24a20a248/", color: "text-gray-200" },
                  { icon: Instagram, name: "Instagram", handle: "@abllz_", url: "https://www.instagram.com/abllz_/", color: "text-gray-300" },
                  { icon: TikTokIcon, name: "TikTok", handle: "@bzlzx", url: "https://www.tiktok.com/@bzlzx", color: "text-gray-100", customIcon: true }
                ].map((social, index) => (
                  <motion.a
                    key={index}
                    href={social.url}
        ...
        <motion.a
          href="https://wa.me/6282141334921?text=Halo%20Ibrahim!%20Saya%20tertarik%20untuk%20berdiskusi%20tentang%20project%20web%20development."
          target="_blank"
          rel="noopener noreferrer"
      ...
      >
        <div className="max-w-7xl mx-auto px-8 md:px-16 text-center">
          ...
          >
            © 2025 Bellz™. All Rights Reserved.
          </motion.div>
        </div>
      </motion.footer>
    </div>
