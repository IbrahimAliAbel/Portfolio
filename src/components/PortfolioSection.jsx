...
const PROJECT_DATA = [
  {
    id: 1,
    title: "KiddoShine",
    description: "KiddoShine is a health-focused application designed to predict and detect potential stunting in children using advanced algorithms. Built with Kotlin for mobile development, Node.js for backend services, and Python for data processing, this project bridges technology with healthcare innovation.",
    technologies: ["Kotlin", "Node.js", "Python"],
    category: "Desktop",
    repositoryUrl: "https://github.com/IbrahimAliAbel/MD-KiddoShine",
    isFeatured: false,
    githubStats: { stars: 24, forks: 8 },
    previewImage: "/images/projects/Kiddoshine.jpg"
  },
  {
    id: 2,
    title: "Cosmix — Custom Apparel Platform",
    description: "Cosmix is a modern e-commerce platform for personalized clothing design and ordering. It enables users to easily browse, customize, and place orders with a sleek interface powered by React and styled with Tailwind CSS. The backend is built on Node.js to ensure smooth and scalable performance.",
    technologies: ["Node.js", "React", "Tailwind"],
    category: "Bot",
    repositoryUrl: "https://github.com/IbrahimAliAbel/Cosmix_Web",
    isFeatured: false,
    githubStats: { stars: 32, forks: 12 },
    previewImage: "/images/projects/cosmix.png"
  },
  {
    id: 3,
    title: "StageUp",
    description: "StageUp is a career platform designed to help students and young professionals discover jobs and internships tailored to their skills and interests. Developed with Kotlin for the mobile app and Firebase as the backend, it provides real-time recommendations and a smooth user experience for career growth.",
    technologies: ["Kotlin", "Firebase"],
    category: "Web",
    repositoryUrl: "https://github.com/IbrahimAliAbel/StageUp",
    isFeatured: false,
    githubStats: { stars: 18, forks: 5 },
    previewImage: "/images/projects/stageup.jpg"
  }
];
...
const CERTIFICATE_DATA = [
  {
    ...
    certificateImage: "/images/certificates/belajarkotlin.jpg",
  ...
  },
  {
    ...
    certificateImage: "/images/certificates/pemula.jpg",
  ...
  },
  {
    ...
    certificateImage: "/images/certificates/fundamental.jpg",
  ...
  },
  {
    ...
    certificateImage: "/images/certificates/intermediete.jpg",
    verificationUrl: "https://www.dicoding.com/certificates/NVP742RKRPR0"
  },
  {
    id: 5,
    ...
    certificateImage: "/images/certificates/machinelearning.jpg",
...
const TECH_STACK_DATA = [
  ...
  },
  {
    ...
    gradientColors: "from-gray-600 to-gray-400",
    category: "Database",
    fallbackText: "🗃️"
  },
  {
